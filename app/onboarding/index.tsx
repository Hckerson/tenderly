                            ...
                            <View className="relative w-full flex-1 items-center  justify-center bg-image-background">
                                <View className="absolute top-0 z-10 h-full w-full flex-1">
                                    <View className="relative inset-0 h-full">
                                        ...
                                        <View className="left-[250px] top-[44px] size-6 rounded-full bg-bubble-primary" />
                                        <View className="left-[330px] top-[120px] size-8 rounded-full bg-bubble-primary" />
                                        <View className="left-[320px] top-[225px] size-3 rounded-full bg-bubble-primary" />
                                    </View>
                                </View>
                                <Image
