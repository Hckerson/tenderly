      ...
      <SwiperFlatList
        ...
        renderItem={({ item }: { item: OnboardingData }) => {
          return (
            ...
            >
              <View className="relative w-full flex-1 items-center  justify-center bg-image-background">
                <View className="absolute top-0 z-10 w-full h-full flex-1">
                  <View className="relative inset-0 h-full">
                    <View className="left-[130px] top-[74px] size-2 rounded-full bg-bubble-primary" />
                    <View className="left-[50px] top-[190px] size-7 rounded-full bg-bubble-primary" />
                    <View className="left-[31px] top-[285px] size-4 rounded-full bg-bubble-primary" />
                    <View className="right-[180px] top-[44px] size-6 rounded-full bg-bubble-primary" />
                    <View className="right-[100px] top-[120px] size-8 rounded-full bg-bubble-primary" />
                    <View className="right-[31px] top-[225px] size-3 rounded-full bg-bubble-primary" />
                  </View>
                </View>
                <Image
              ...
              <View className=" absolute bottom-0 z-10 h-[300px] w-full  items-center justify-between bg-background-secondary pb-[19px]">
                <View className="w-full flex-1 translate-y-8 items-center  justify-center gap-y-4">
                  ...
                  <Text className="w-full text-center text-text-secondary ">
                    {item.about}
                  </Text>
                </View>
